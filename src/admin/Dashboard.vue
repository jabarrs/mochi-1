...
export default {
    ...
    methods: {
        ...
        async getAllBills() {
            this.allBills = (await axios.get(`${process.env.API_BASE_URL}/billstatus`)).data;
        },
        ...
        async nextStatusBtn(id) {
            await axios.put(`${process.env.API_BASE_URL}/billstatus/` + id);
            this.getAllBills();
        },

        async paidBtn(id) {
            await axios.put(`${process.env.API_BASE_URL}/billstatus/paid/` + id);
            this.getAllBills();
        },

        async cancelBtn(id) {
            await axios.put(`${process.env.API_BASE_URL}/billstatus/cancel/` + id);
            this.getAllBills();
        },
