...
export default {
    ...
    methods: {
        ...
        async getAllFoods() {
            if (this.bill) {
                let data = (await axios.get('https://be-rest.vercel.app/api/billdetails/' + this.bill)).data;
        ...
        async getBillStatus() {
            if (this.bill) {
                this.billMatch = (await axios.get('https://be-rest.vercel.app/api/billstatus/bill/' + this.bill)).data[0];
            }
        },
    }
}
