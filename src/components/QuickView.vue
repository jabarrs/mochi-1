...
export default {
    ...
    methods: {
        ...
        async addToCart() {
            let existItem = await axios.get('https://be-rest.vercel.app/api/cartItem/' + parseInt(this.user.user_id) + '/' + parseInt(this.food));
            ...
            if (existItem.data.length == 1) {
                ...
                await axios.post("https://be-rest.vercel.app/api/cartItem/", data)
                this.$refs.alert.showAlert('success', 'Thank you!', 'Add To Cart Successfully !')
            }
        }
    },
