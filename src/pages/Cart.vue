...
export default {
    ...
    methods: {
        ...
        async onQtyChange(e, i) {
            ...
            await axios.put("https://be-rest.vercel.app/api/cartItem/", data)
        },

        async cancelBtn() {
            await axios.delete("https://be-rest.vercel.app/api/cartItem/" + this.user.user_id);
        ...
        async removeBtn(index) {
            await axios.delete("https://be-rest.vercel.app/api/cartItem/" + this.user.user_id + "/" + this.cartItem[index]);
