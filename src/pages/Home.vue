    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Traditional Mochi Indonesia 😋</h3>
                <p>We guarantee to use fresh food with the best quality. Customers will enjoy Indonesia cuisine with
                    explosive, sophisticated flavors.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/moci-logo.png" alt="" class="home-img">
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <p> Aktif di media sosial, sering membagikan konten tentang makanan dan gaya hidup sehat.
                    Menyukai eksplorasi kuliner dan mencoba makanan baru.
                    Peduli terhadap kesehatan dan lebih memilih makanan yang menggunakan bahan alami.
                Nilai dan Preferensi:
                    Mencari makanan yang tidak hanya enak tetapi juga menarik secara visual untuk dibagikan di media sosial.
                    Memiliki ketertarikan pada produk yang ramah lingkungan dan berkelanjutan.
            </p>
