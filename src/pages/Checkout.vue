        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                <div class="checkout-heading">
                    <h3>more step to place your order<span>Total</span></h3>
...
export default {
    ...
    methods: {
        ...
        async getAllCartItem() {
            if (this.user) {
                let existItem = await axios.get('https://be-rest.vercel.app/api/cartItem/' + this.user.user_id);
        ...
        checkForm: function () {
            ...
            if (!this.checkoutObj.phone) {
                ...
                if (this.checkoutObj.phone.length != 14) {
        ...
        async sendBillDetails(billId, foodId, qty) {
            ...
            await axios.post("https://be-rest.vercel.app/api/billdetails", billDetails);
        },
        ...
        async handleSubmit(e) {
            ...
            if (!this.checkEmptyErr()) {
                ...
                e.preventDefault();
                let billId = (await axios.get("https://be-rest.vercel.app/api/billstatus/new")).data;
                ...
                axios.post("https://be-rest.vercel.app/api/billstatus", billStatus);
                axios.delete("https://be-rest.vercel.app/api/cartItem/" + this.user.user_id);
