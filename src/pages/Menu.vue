        ...
        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                <div class="row search-box">
                    <input type="text" class="search-input " style="padding-left: 10px; border-radius:5px" v-model="foodObj.name" placeholder=" Search.." />
                </div>

                <div class="row filter-drop-down" style="border-radius: 5px;">
                    <p @click="displayFilterDrop" class="ml-3">Filter <span v-if="showDropDown">x</span><span v-else>v</span></p>
                </div>
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rPrice" id="rtfPrice" value="30000,50000" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rtfPrice" class="d-flex justify-content-between">Rp.30000 - Rp.50000 <button
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="100000,120000" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">Rp.100000 - Rp.120000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="ltPrice" value="30000" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="ltPrice" class="d-flex justify-content-between">{{ "<" }} Rp.30000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs" style="border-radius: 5px;">
                        <input type="button" id="allFilterFoodBtn" name="allFilterFoodBtn" 
                            class="menu-tab-item" value="all" @click="filterFoodBtn($event)" />
